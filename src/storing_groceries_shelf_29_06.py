...
objs = bproc.loader.load_blend("/home/sorin/blenderdata/blender_data/robocup/scenes/synthetic-data_shelf2.blend")
output_path="/home/sorin/code/blenderproc/test"
...
poi = [[4.9, 8.4, 1.1], [4.9, 8.4, 0.6], [4.9, 8.4, 0.3]]
...
def camera_poses_random(x):
    for i in range(x):
        for p in poi:
            location = np.random.uniform([4.5, 7.0, 1.0], [5.5, 7.2, 1.4])
            #location = location
            # Compute rotation based on vector going from location towards poi
